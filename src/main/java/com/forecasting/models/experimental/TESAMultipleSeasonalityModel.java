...
@Data
public class TESAMultipleSeasonalityModel extends AbstractForecastModel {
     ...
     */
    public TESAMultipleSeasonalityModel(int trainPoints, int validationPoints, int seasonality1, int seasonality2) {
     ...
     * @param gamma
     */
    public TESAMultipleSeasonalityModel(int trainPoints, int validationPoints, int seasonality1, int seasonality2, float alpha, float beta, float gamma, float delta) {
...
//                = initializeSeasonality(startPoint, endPoint);
