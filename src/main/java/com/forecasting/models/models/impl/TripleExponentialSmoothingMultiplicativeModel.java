...
@Data
public class TripleExponentialSmoothingMultiplicativeModel extends AbstractForecastModel {
     ...
     */
    public TripleExponentialSmoothingMultiplicativeModel(int trainPoints, int validationPoints, int seasonalPeriod) {
     ...
     * @param gamma
     */
    public TripleExponentialSmoothingMultiplicativeModel(int trainPoints, int validationPoints, int seasonalPeriod, float alpha, float beta, float gamma) {
