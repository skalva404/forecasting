...
@Data
public class TripleExponentialSmoothingAdditiveModel_2 extends AbstractForecastModel {
     ...
     */
    public TripleExponentialSmoothingAdditiveModel_2(int trainPoints, int validationPoints, int seasonalPeriod) {
     ...
     * @param gamma
     */
    public TripleExponentialSmoothingAdditiveModel_2(int trainPoints, int validationPoints, int seasonalPeriod, float alpha, float beta, float gamma) {
