...
public class BenchmarkSiteForecastTest extends TestCase {


    private static Logger logger = Logger.getLogger(BenchmarkSiteForecastTest.class.getName());
    private static final String DELIM1 = ",";
    private static final String DELIM2 = "|";
    private static final int BATCH_SIZE = 200;


    public BenchmarkSiteForecastTest(String testName) {
        super(testName);
        try {
    ...
    public static Test suite() {
        return new TestSuite(BenchmarkSiteForecastTest.class);
    }
    ...
    public void testGoldenDataSet() {
        try {
            ...
            String strLine;
            String fileName = this.getClass().getResource(ConfigManager.get("input.site")).getPath();
    ...
    private void writeMetricsToFile(Map<String, DataSet> dataSetMap) {
        ...
        try {
            ...
            String fileName = this.getClass().getResource(ConfigManager.get("metrics.site")).getPath();
            System.out.println("fileName = " + fileName);
    ...
    private Map<String, double[]> loadActualData() {
        try {
            ...
            String fileName = this.getClass().getResource(ConfigManager.get("testDataSet.site")).getPath();
    ...
    private void writeToFile(Map<String, DataSet> dataSetMap) {
        ...
        try {
            String fileName = this.getClass().getResource(ConfigManager.get("output.site")).getPath();
            BufferedWriter fileWriter = new BufferedWriter(new FileWriter(new File(fileName)));
