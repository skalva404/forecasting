...
public class TESAwithMultipleSeasonalityTest extends TestCase {

    public TESAwithMultipleSeasonalityTest(String testName) {
        super(testName);
        try {
    ...
    public static Test suite() {
        return new TestSuite(TESAwithMultipleSeasonalityTest.class);
    }
    ...
    public void testMultipleSeasonality() throws IOException, ModelInitializationException {
        ...
        ForecastModel model = new TESAMultipleSeasonalityModel(65,13,4,13);
