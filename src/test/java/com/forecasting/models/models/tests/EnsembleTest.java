...
import com.forecasting.models.models.impl.TripleExponentialSmoothingAdditiveModel;
...
public class EnsembleTest extends TestCase {
    ...
    public EnsembleTest(String testName) {
        super(testName);
    }
...
//        executor.addModel(new TripleExponentialSmoothingAdditiveModel(35, 7, 7, false));
