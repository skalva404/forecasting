...
import com.forecasting.models.models.impl2.FFTModel_2;
...
public class FFTModelTest_2 extends TestCase {


    public FFTModelTest_2(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(FFTModelTest_2.class);
    }

    public void testFFTModel() throws ModelInitializationException {
        ...
        if (timeSeries.size() == points) {
            ForecastModel ses = new FFTModel_2(35, 7, 7, 15);
            ses.init(timeSeries);
            ses.train();
            ses.forecast(7);
