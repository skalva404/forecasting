...
import com.forecasting.models.models.impl2.TripleExponentialSmoothingMultiplicativeModel_2;
import com.forecasting.models.models.util.SampleDataFactory;
import junit.framework.Test;
import junit.framework.TestCase;
import junit.framework.TestSuite;

public class TripleExponentialSmoothingMultiplicativeTest_2 extends TestCase {

    public TripleExponentialSmoothingMultiplicativeTest_2(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TripleExponentialSmoothingMultiplicativeTest_2.class);
    }

    public void testTripleExponentialSmoothingMultiplicative() throws ModelInitializationException {
        SampleDataFactory dataFactory = new SampleDataFactory();
        DataSet dataSet = dataFactory.getSeasonalDummyDataSet(42, 7);
        TripleExponentialSmoothingMultiplicativeModel_2 model=new TripleExponentialSmoothingMultiplicativeModel_2(35,7,7);
