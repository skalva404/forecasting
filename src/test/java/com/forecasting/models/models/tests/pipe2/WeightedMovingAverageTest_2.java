...
import com.forecasting.models.models.impl2.WeightedMovingAverageModel_2;
...
public class WeightedMovingAverageTest_2 extends TestCase {


    public WeightedMovingAverageTest_2(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(WeightedMovingAverageTest_2.class);
    }
    ...
    public void testSES() throws ModelInitializationException {
        ...
        {
        ForecastModel ses = new WeightedMovingAverageModel_2(null,7,35, 7);
        ses.init(timeSeries);
        ses.train();
        ses.forecast(7);
